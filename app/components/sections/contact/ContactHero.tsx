...
import Pic from "@/public/pics/1301-damac/building-wide.jpg";
    ...
    <section className="relative min-h-[500px] md:min-h-[600px] lg:min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Ready to maximize your property's potential? Let's discuss how we
            can help you achieve exceptional returns
          </motion.p>
        </div>
      </div>
